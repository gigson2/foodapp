...
export const mockReviews: Review[] = [
    {
        ...
        rating: 5,
        message: 'The lamb was very tender and the packaging was clean. Pickup was simple and the flavor stayed consistent all the way home.',
        foodName: 'Grilled Lamb Pack',
        status: 'approved',
    ...
    },
    {
        ...
        rating: 4,
        message: 'I liked the mixed pack because the lamb and chicken both came fresh, hot, and neatly arranged in the takeaway container.',
        foodName: 'Mixed Lamb & Chicken Pack',
        status: 'approved',
